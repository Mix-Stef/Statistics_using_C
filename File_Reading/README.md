Read_file.c is a script that reads a .csv file (with delimiter ","), counts the number of columns as well as computes the sum, mean, variance and standard deviation of a given column. 
