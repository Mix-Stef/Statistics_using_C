Read_file.c is a script that reads a .csv file (with delimiter ","), counts the number of columns and rows as well as computes the sum, mean, max, min, variance and standard deviation of a given column. 
